    ...
    <main className="min-h-screen bg-[#f3f4f6] text-[#18211f]">
      ...
      <section className="border-b border-[#dce5dc] bg-[#eef6ed]">
        <div className="mx-auto max-w-7xl px-5 py-16">
          <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#0e7a5f]">Child Safety Resource Library</p>
          <h1 className="mt-4 max-w-4xl text-4xl font-black leading-tight sm:text-5xl">
            Helpful articles for parents comparing safer baby gear, toys, childproofing products, travel gear, bath items, and emergency essentials.
          </h1>
      ...
      <section className="bg-[#f3f4f6]">
        <div className="mx-auto max-w-7xl px-5 py-14">
          <div className="mb-8">
            ...
            <h2 className="mt-3 text-3xl font-black">Explore child safety buying topics.</h2>
            <p className="mt-3 max-w-3xl text-base leading-8 text-[#5d6d66]">
              These hub pages organize the core questions parents ask before choosing safety gear, childproofing products, toys, strollers, and nursery essentials.
            </p>
          </div>
