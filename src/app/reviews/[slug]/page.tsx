...
export async function generateMetadata({ params }: ReviewPageProps): Promise<Metadata> {
  ...
  if (!product) {
    return {
      title: "Safety Pick Not Found",
    };
  }

  return {
    title: `${product.name} Safety Checklist`,
    ...
    openGraph: {
      ...
      type: "article",
      publishedTime: "2026-07-03T00:00:00-04:00",
    ...
    "@graph": [
      {
        ...
        url: reviewUrl,
        name: `${product.name} Safety Checklist`,
        description: product.summary,
        isPartOf: {
      ...
      },
      {
        ...
        headline: `${product.name} Safety Checklist`,
        description: product.summary,
        image: absoluteUrl(product.image),
        author: { "@id": absoluteUrl("/#organization") },
        publisher: { "@id": absoluteUrl("/#organization") },
        mainEntityOfPage: reviewUrl,
        datePublished: "2026-07-03T00:00:00-04:00",
        dateModified: "2026-08-25T00:00:00-04:00",
        articleSection: product.category,
        isAccessibleForFree: true,
        keywords: [product.category, product.bestFor, "child safety shopping guide", decision.searchIntent].join(", "),
        inLanguage: "en-US",
      },
      {
        "@type": "FAQPage",
    ...
    <main className="min-h-screen bg-[#f3f4f6] text-[#18211f]">
      ...
      <section className="bg-[#eef6ed]">
        <div className="mx-auto grid max-w-5xl gap-8 px-5 py-12 lg:grid-cols-[1fr_320px] lg:items-center">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-black leading-tight sm:text-5xl">{product.name} Safety Checklist</h1>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link href="/resources/topics/baby-proofing-checklist" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-md border border-[#cbd8cf] bg-white px-5 py-3 text-sm font-black uppercase tracking-[0.1em] text-[#10231f] hover:border-[#0e7a5f]">
                Safety guide
      ...
      <div className="mx-auto grid max-w-5xl gap-8 px-5 py-10 lg:grid-cols-[1fr_280px] lg:items-start">
        <article className="rounded-lg border border-[#dce5dc] bg-white p-6 shadow-sm sm:p-8">
          ...
          <section>
            <h2 className="mt-8 text-2xl font-black">Who this safety pick is best for</h2>
        ...
        <aside className="rounded-lg border border-[#dce5dc] bg-white p-5 shadow-sm">
          ...
          <div className="mt-5 rounded-lg bg-[#fbfcf8] p-4">
            ...
            <p className="mt-2 text-sm leading-7 text-[#5d6d66]">
              This guide is general buying information, not pediatric, legal, installation, manufacturer, or professional safety advice. Follow the product manual, official recall notices, and age or fit requirements.
            </p>
          </div>
          ...
          <div className="mt-5 border-t border-[#e6ece5] pt-5">
            ...
            <div className="mt-3 grid gap-2 text-sm font-bold text-[#40514b]">
              <Link href="/resources/topics/baby-proofing-checklist" className="hover:text-[#0e7a5f]">Baby Proofing Checklist</Link>
              <Link href="/resources/topics/safer-toys-by-age" className="hover:text-[#0e7a5f]">Safer Toys by Age</Link>
