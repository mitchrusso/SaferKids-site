...
export const metadata: Metadata = {
  title: "Child Safety Buying FAQ",
  description:
    "Answers to common questions about Safer Kids, child safety reviews, affiliate links, safety guidance, and online buying decisions.",
  alternates: {
    canonical: "/faq",
  },
};
  ...
  return (
    <main className="min-h-screen bg-[#f3f4f6] px-5 py-16 text-[#18211f]">
      ...
      <article className="mx-auto max-w-4xl rounded-lg bg-white p-8 shadow-sm sm:p-12">
        ...
        <h1 className="mt-8 text-4xl font-black">Child Safety Buying FAQ</h1>
        <p className="mt-6 text-base leading-8 text-[#5d6d66]">
          Quick answers about using Safer Kids, comparing safety-first product categories, affiliate links, and safety considerations before buying childproofing products, toys, strollers, car seats, or nursery gear.
        </p>
